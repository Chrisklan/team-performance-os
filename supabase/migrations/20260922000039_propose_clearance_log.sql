-- =============================================================================
-- 20260922000039_propose_clearance_log.sql (Quelle: backend/28_propose_clearance_log.sql) — der Vorschlag der Physio kommt in die Zugriffsuebersicht (Punkt 56, Befund N8)
--
