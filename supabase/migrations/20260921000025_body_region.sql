-- Migration 20260921000025_body_region.sql (AP-43, Modul-Body-Map Abschnitt 6)
-- Quelle: backend/16_body_region.sql (identisch). Tests: backend/16_body_region.pgtap.sql.
-- Legt den Regionskatalog als Referenztabellen an und befuellt sie aus
-- backend/body_regions.json. Legt nur neue Tabellen an und schreibt nur in
-- diese, fasst keine bestehende Zeile an.
