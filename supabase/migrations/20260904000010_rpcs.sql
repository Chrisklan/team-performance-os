...
-- =============================================================================
CREATE TABLE IF NOT EXISTS app.access_log (id uuid);
CREATE TABLE IF NOT EXISTS app.readiness_scores (id uuid);
CREATE TABLE IF NOT EXISTS app.load_deviations (id uuid);
CREATE TABLE IF NOT EXISTS app.daily_checkins (id uuid);
