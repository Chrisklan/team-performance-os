-- =============================================================================
-- 20260922000040_clearance_admin_adr018.sql (Quelle: backend/29_clearance_admin_adr018.sql) — ADR-018 angenommen, der admin Zweig ist jetzt begruendet (Punkt 53, Befund N2)
--
