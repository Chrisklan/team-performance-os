-- Migration 20260919000022_checkin_api_wrapper.sql (AP-34)
-- Quelle: backend/13_checkin_api.sql (identisch). Tests: backend/13_checkin_api.pgtap.sql.
-- Schreibt keine Daten, legt nur die Funktion an.
